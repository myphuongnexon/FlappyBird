...
export default restart => {
    ...
    return{
        ...
        ObstacleBottom1: Obstacle(world, 'ObstacleBottom1', 'b;ue', pipeSizePosA.pipebottom.pos, pipeSizePosA.pipebottom.size),

        ObstacleTop2: Obstacle(world, 'ObstacleTop2', 'red', pipeSizePosB.pipetop.pos, pipeSizePosB.pipetop.size),

        ObstacleBottom2: Obstacle(world, 'ObstacleBottom2', 'b;ue', pipeSizePosB.pipebottom.pos, pipeSizePosB.pipebottom.size),
